        ...
        <nav>
            <div class="cp_navi">
                <ul>
                    ...
                    <li><a href="membership.html"><i class="far fa-handshake"></i> Membership</a></li>
                    <li><a href="notice.html"><i class="fas fa-bell"></i> Notice</a></li>
                    <li><a href="upload.html"><i class="fas fa-video"></i> Upload</a></li>
        ...
        <div class="container emp-profile">
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <input type="button" class="profile-edit-btn" name="btnAddMore" value="Finished" onClick="location.href='pf.php'" />
                        <!-- <div class="btn-group">
